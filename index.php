...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['login_submit'])) {
        ...
        $query = "SELECT * FROM accounts WHERE email='$login_email'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (password_verify($login_password, $row['password'])) {
                ...
                $_SESSION['is_root'] = $row['root'] == 1;

                header("Location: /vasea/pages/home.php");
                exit();
            } else {
        ...
        if ($signup_password === $confirm_password) {
            ...
            $query = "INSERT INTO `accounts` (email, password) VALUES ('$signup_email', '$hashed_password')";
            if (mysqli_query($conexiune, $query)) {
                echo "Signup successful!";
            } else {
                echo "Error: " . $query . "<br>" . mysqli_error($conexiune);
            }
        } else {
...
<div class="container">
    ...
    <div class="registration form">
        ...
        <form action="" method="POST">
            ...
            <input type="submit" name="signup_submit" class="button" value="Signup">
        </form>
        <div class="signup">
